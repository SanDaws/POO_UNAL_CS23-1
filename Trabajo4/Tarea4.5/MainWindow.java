...
public class MainWindow extends JFrame implements ActionListener{
    ...
    private PeopleList lista; // El objeto ListaPersonas de la aplicación
    ...
    */
    public MainWindow(){
        lista = new PeopleList(); // Crea la lista de personas
        inicio();
    ...
    private void inicio() {
        ...
        */
        private void anadirPersona(){
            ...
            persona */
            Person p = new Person(campoNombre.getText(),
